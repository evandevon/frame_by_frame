...
- If the camera has focus control an 'autofocus' tickbox appears. If unticked, a focus slider appears for manual control, if available on the attached webcam.
...
**Future Features**
- Chromakey and painting features
- Asset library of overlays
- Adding simple audio tracks for music and sound effects
